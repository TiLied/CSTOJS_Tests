...
internal class UnitTest
{
	...
	{
		p7();
		//var e = GlobalThis.Window.Document.CreateElement("div", new ElementCreationOptions() { Is = "" });
		//ParentNode2? e = ParentNode2.Test;
	...
	public void p7()
	{
		...
		Console.WriteLine($"Solution One- Answer for the Problem #7 is : {number}");
...
count++; 
		...
		Console.WriteLine($"Solution Two- Answer for the Problem #7 is : {index}");
